...
if __name__ == '__main__':
    ...
    # 从csv文件中读取数据
    filename = 'subsession-time120-r5.2.csv.gz'
    ...
    clfs = {'LightGBM': LGBMClassifier(random_state=42,n_jobs=n_cores,num_leaves=25,min_child_samples= 31,n_estimators=300,learning_rate=0.05,reg_alpha= 0.1, reg_lambda=0.5),
    ...
    res = split_data(data, test_size=0.5, random_state=42, y_column='insider',
                     shuffle=True,
                     x_rm_cols=('user', 'day', 'week', 'starttime', 'endtime', 'sessionid',
                                'timeind', 'Unnamed: 0', 'insider'),
                     dname='r5.2', normalization='StandardScaler',
                     rm_empty_cols=False, by_user=False, by_user_time=False,
                     by_user_time_trainper=0.5, limit_ntrain_user=0)
